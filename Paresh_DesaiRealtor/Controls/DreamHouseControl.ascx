                                    ...
                                    <div class="construction_bg">
                                       <div class="construction_hdng"><span><%# Eval("Title") %></span></div>
                                        <div class="construction_price"><span><%# Eval("Price") %></span></div>
                                         ...
                                         <asp:HyperLink ID="hypBoxreadmore" NavigateUrl='<%# Eval("Id", "~/DreamHouseDetail.aspx?ID={0}") %>' CssClass="read_more_btn3 new_btn" Text="Read More" runat="server"></asp:HyperLink>
                                        </div>
